...
DevOps:
<p align="left">
<a href="https://www.git-scm.com/" target="_blank" rel="noreferrer"> <picture> <source media="(prefers-color-scheme: dark)" srcset="git/git-original-wordmark.svg" /> <source media="(prefers-color-scheme: light)" srcset="git/git-original-wordmark.svg" /> <img src="git/git-original-wordmark.svg" alt="git" width="40" height="40" /> </picture> </a>&nbsp;
